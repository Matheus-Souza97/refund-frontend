...
export function Dashboard() {
  ...
  return (
    <div className=" bg-gray-500 rounded-xl p-10 md:max-w-3xl m-auto">
      <h1 className="text-gray-100 font-bold text-xl flex-1">Solicitacões</h1>
      ...
      <div className="my-6 flex flex-col gap-4 max-h-96 overflow-y-scroll">
        {refunds.map((item) => (
